...
public class MaterialsService implements MaterialService {
    ...
    public MaterialsService(MaterialRepository materialRepository, SubjectService subjectService, ClassService classService, UserService userService, ModelMapper modelMapper, MaterialSchoolRepository materialSchoolRepository) {
    ...
    @Override
    public void saveMaterials(MaterialImportBindingModel[] materials) {
        Arrays.stream(materials).forEach(m -> {
