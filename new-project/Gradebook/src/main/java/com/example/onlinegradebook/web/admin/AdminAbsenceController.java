...
public class AdminAbsenceController {
    ...
    public String addAbsenceToStudent(@PathVariable String id) {
        ...
        return String.format("redirect:/admin/absence/%s",userService.getById(id).getUserClass().getId());
    }
    ...
    public String removeLateFromStudent(@PathVariable String id) {
        ...
        return String.format("redirect:/admin/absence/%s",schoolId);
    }
}
